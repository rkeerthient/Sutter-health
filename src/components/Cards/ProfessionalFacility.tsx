  ...
  return (
    <div className="flex flex-1 p-2 border flex-col">
      ...
      <div className="flex gap-2 mx-auto w-full mt-4">
        ...
        <div className="w-1/2 uppercase text-[#066] hover:text-white border-2 border-[#066] hover:bg-[#066] hover:cursor-pointer font-bold text-center rounded-sm px-4 py-2  ">
          View Location
        </div>
      </div>
    </div>
